...
include 'controller/funcsMailer.php';
        ...
        if($arr['success'])
        {
            ...
            if($registro > 0)
            {
                ...
                if(enviarEmail($email, $nombre, $asunto, $cuerpo)){
                    ...
                    echo "<br><a href='principal.php' >Iniciar Sesion</a>";
                    exit;
                } else {
    ...
    <div id="signupbox" style="margin-top:50px" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
        <div class="panel panel-info">
            <div class="panel-heading">
                ...
                <div style="float:right; font-size: 85%; position: relative; top:-10px"><a id="signinlink" href="principal.php">Iniciar Sesi&oacute;n</a></div>
            </div>
